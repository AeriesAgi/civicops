...
CivicOps supports both a safe WhatsApp demo simulator and real WhatsApp Cloud API webhook/send readiness. Demo mode works without Meta credentials. Live send is only attempted when explicitly enabled and all send credentials are present.
